...
import * as akashMarketV1beta3ServiceRegistry from "./market/v1beta3/service.registry";
...
import * as akashMarketV1beta3ServiceAmino from "./market/v1beta3/service.amino";
...
export const akashAminoConverters = {
  ...
  ...akashMarketV1beta3ServiceAmino.AminoConverter,
...
export const akashProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...akashAuditV1beta1AuditRegistry.registry, ...akashAuditV1beta2AuditRegistry.registry, ...akashAuditV1beta3AuditRegistry.registry, ...akashCertV1beta2CertRegistry.registry, ...akashCertV1beta3CertRegistry.registry, ...akashDeploymentV1beta1DeploymentRegistry.registry, ...akashDeploymentV1beta2ServiceRegistry.registry, ...akashDeploymentV1beta3ServiceRegistry.registry, ...akashMarketV1beta2ServiceRegistry.registry, ...akashMarketV1beta3ServiceRegistry.registry, ...akashMarketV1beta4ServiceRegistry.registry, ...akashProviderV1beta1ProviderRegistry.registry, ...akashProviderV1beta2ProviderRegistry.registry, ...akashProviderV1beta3ProviderRegistry.registry];
